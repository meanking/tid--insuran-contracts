...
contract Bonus is IBonus, Ownable, WeekManaged {
    ...
    function updateSellerBonus(uint16 assetIndex_) external {
        ...
        IERC20(registry.unoToken()).approve(registry.seller(), bonusPerAssetOfS[assetIndex_]);
    ...
    function updateGuarantorBonus(uint16 assetIndex_) external {
        ...
        IERC20(registry.unoToken()).approve(registry.guarantor(), bonusPerAssetOfG[assetIndex_]);
