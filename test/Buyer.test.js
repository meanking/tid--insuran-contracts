...
const UnoToken = artifacts.require('UnoToken');
...
contract('Buyer', ([dev, seller0, buyer0]) => {
    ...
    beforeEach(async () => {
        ...
        this.uno = await UnoToken.new({ from: dev });
        ...
        await this.registry.setUnoToken(this.uno.address, { from: dev });
        ...
        // Setup bonus and prepare enough UNO.
        await this.bonus.setBonusPerAssetOfS(0, 10000, { from: dev });
        await this.uno.transfer(this.bonus.address, 50000, { from: dev });
